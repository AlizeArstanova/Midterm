...
library(ggh4x)
data_set %>%
  filter(country == c("Argentina", "Australia", "Belarus", "Uganda", "Canada", "Japan")) %>% 
  ggplot() +
  aes(year) +
  ...
  labs(x = "year",
       y = "rate",
       title = "Migration and unemployment rates") +
  theme_ipsum_rc() +
